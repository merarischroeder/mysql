...
Pool.prototype.borrowedConnections = function () {
	return this._borrowedConnections.slice(); //copy the array, so caller doesn't have access to internal array 
};
